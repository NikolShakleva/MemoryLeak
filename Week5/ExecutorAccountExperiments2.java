...
public class ExecutorAccountExperiments2 implements ExecutorService {
  
  //private static final int NTHREADS= 2;
  //private static ExecutorService exec1= Executors.newFixedThreadPool(NTHREADS);
  ...
  public static void main(String[] args) {
    ...
    //exec.execute(task);
     for(int i = 2 ; i < 32 ; i+=2 ){
      var exec = Executors.newFixedThreadPool(i);
      //var a = new ExecutorAccountExperiments2(i);
      long start = System.nanoTime();
      exec.execute(task);
      exec.shutdown();
      long end = System.nanoTime()-start;
      System.out.println("number of threads: " +i +" time: "+ end + " sleep time: 1");
