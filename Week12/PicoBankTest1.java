...
class PicoBankTest1 {
  ...
  public static void main(String[] args) throws InterruptedException, BrokenBarrierException{
     for(int i = 0; i < 10; i++) {
      ...
      testBankParellel(new PicoBankBasic1 (N));
    }
 }
...
/////////////////////
//PicoBankBasic1 class
/////////////////////

class PicoBankBasic1 implements PicoBank{
  final int N; // Number of accounts
  final Account[] accounts ;
  
  PicoBankBasic1(int noAccounts){
    N = noAccounts;
  ...
  static class Account{
    ...
    public synchronized void deposit(long sum){ balance += sum; } 
    public synchronized void withdraw(long sum){ balance -= sum; }
